...
namespace Infrastructure.Services
{
    public class AccountService: IAccountService
    {
        ...
        //public async Task<UserLoginModel> ValidateUser(UserLoginModel model)
        //{
        ...
        public async Task<int> RegisterUser(UserRegisterModel model)
        {
            ...
            // hash the password with the salt created in above step: Pdkdf2, Bcrypt
        ...
        public async Task<UserLoginSuccessModel> ValidateUser(UserLoginModel model)
        {
            ...
            if (user == null)
            {
                throw new Exception("Email does not exist, register first.");
            }
