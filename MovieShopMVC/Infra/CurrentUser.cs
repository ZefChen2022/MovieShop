...
namespace MovieShopMVC.Infra
{
    public class CurrentUser : ICurrentUser
    {
        ...
        public int UserId => Convert.ToInt32(_contextAccessor.HttpContext.User.
        ...
        public string FullName => _contextAccessor.HttpContext.User.Claims.
            FirstOrDefault( c=> c.Type == ClaimTypes.GivenName).Value +" " +
            _contextAccessor.HttpContext.User.Claims.FirstOrDefault
